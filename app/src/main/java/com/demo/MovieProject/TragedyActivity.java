...
public class TragedyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tragedy);
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent BackHome = new Intent(TragedyActivity.this,MainActivity.class);
                startActivity(BackHome);}});

        imgLogout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent Logout = new Intent(TragedyActivity.this,LoginActivity.class);
        ...
        butSubmit.setOnClickListener(new View.OnClickListener() {
                                         ...
                                         public void onClick(View v) {
                                             ...
                                             if (txtQty.getText().toString().equals("")) {
                                                 ...
                                                 Intent i = new Intent(TragedyActivity.this, PaymentActivity.class);
