    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent BackHome = new Intent(SocialActivity.this,MainActivity.class);
                startActivity(BackHome);}});

        imgLogout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent Logout = new Intent(SocialActivity.this,LoginActivity.class);
        ...
        butSubmit.setOnClickListener(new View.OnClickListener() {
                                         ...
                                         public void onClick(View v) {
                                             ...
                                             if (txtQty.getText().toString().equals("")) {
                                                 ...
                                                 Intent i = new Intent(SocialActivity.this, PaymentActivity.class);
