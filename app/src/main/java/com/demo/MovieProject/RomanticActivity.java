    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent BackHome = new Intent(RomanticActivity.this,MainActivity.class);
                startActivity(BackHome);}});

        imgLogout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent Logout = new Intent(RomanticActivity.this,LoginActivity.class);
        ...
        butSubmit.setOnClickListener(new View.OnClickListener() {
                                         ...
                                         public void onClick(View v) {
                                             ...
                                             if (txtQty.getText().toString().equals("")) {
                                                 ...
                                                 Intent i = new Intent(RomanticActivity.this, PaymentActivity.class);
